    ...
    render() {
        ...
        return (
            ...
            <div>
                ...
                <div style={{ paddingBottom: '150px', display: 'block', backgroundColor: '#fff' }}>
                    <h1 style={{
                    ...
                    <div style={{
                        width: '90%', backgroundColor: '#fff', margin: '0 auto', display: 'flex', justifyContent: 'space-around',
                    }}
                    >
                    ...
                    {button3 ? (
                        <Link
                            ...
                            style={{
                                display: 'flex',
                                flex: 1,
                                background: 'black', color: '#c7c7c7', margin: '40px auto', padding: '10px', textTransform: 'uppercase', letterSpacing: '0.25em', borderRadius: '3px', border: 'none', fontSize: '16px', justifyContent: 'center', alignitems: 'center', cursor: 'pointer', textDecoration: 'none', maxWidth: '250px',
                            }}
                        >Battle
                        </Link>
                    )
